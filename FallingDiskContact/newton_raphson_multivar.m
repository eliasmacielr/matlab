function [x,iter] = newton_raphson_multivar(F,x0,h,sym_vars,sym_eqns,tol,maxit)
...
%
%input:     F:          column vector of n functions
%           tol:        maximum tolerable RSS of errors in output vector
...
% Calculate the Jacobian (just once)
J = zeros(n,n);
for i = 1:n
    for j = 1:n
        J(i,j) = (1)/(2*h); % TODO: Replace 1 with the correct expression
    end
end
